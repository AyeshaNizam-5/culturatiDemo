...
export interface GameImportDialogProps {
  open: boolean
              ...
              <div className="space-y-3 pt-2">
                ...
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="append" id="game-append" />
                    <Label htmlFor="game-append">
                  ...
                  {hasExistingData && duplicateCount > 0 && (
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="skip-conflicts" id="game-skip-conflicts" />
                      <Label htmlFor="game-skip-conflicts">
                  ...
                  {hasExistingData && (conflictCount - duplicateCount) > 0 && (
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="replace-conflicts" id="game-replace-conflicts" />
                      <Label htmlFor="game-replace-conflicts">
