    ...
    <div className="flex flex-col md:flex-row gap-4 mb-6">
      <div className="relative flex-1">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-[#0f172a] rounded-lg text-white placeholder:text-gray-400 
      ...
      <select
        ...
        className="px-4 py-2.5 bg-[#0f172a] rounded-lg text-white border border-gray-700
