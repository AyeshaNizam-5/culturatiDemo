...
const RouteStartInfo = ({ isExpanded, onExpand }: { isExpanded: boolean; onExpand: () => void }) => {
  const [open, setOpen] = useState(false);
  const [title, setTitle] = useState('Route Introduction');
  const [paragraph, setParagraph] = useState('This is a brief introduction to the route.');
